...
export default function ContactSection() {
  ...
  return (
    <section id="contato" ref__={ref} style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 24px 100px", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(50px)", transition: "all 0.9s cubic-bezier(0.16,1,0.3,1)" }}>
      <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 28, padding: "clamp(40px, 6vw, 64px)", backdropFilter: "blur(20px)", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", position: "relative", zIndex: 1 }}>
          ...
          <a href__="https://mail.google.com/mail/?view=cm&fs=1&to=hidraulicamoreninha@gmail.com" target="_blank" rel="noreferrer"
